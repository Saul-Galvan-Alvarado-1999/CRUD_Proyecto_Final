...
<head>
    ...
    <title>{{ ('CRUD  -Saúl Galván Alvarado-') }}</title>
...
<footer class="footer">
<div class="footer-copyright text-center py-3" class="footer__p" position: fixed;>© 2021 Copyright, Elaboro Saúl Galván Alvarado
